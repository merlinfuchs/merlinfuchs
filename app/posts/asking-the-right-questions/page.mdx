...
![Stupid Questions](/stupid-questions.jpg)
...
It's import to still keep you questions as concise as possible and only include information that are actually relevant.
It does not help to unrelated information just to include as much as possible.
