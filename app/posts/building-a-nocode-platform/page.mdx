...
<PostDate date="2024-10-08" />

![Interactive no-code flow builder of Kite](/kite-flow.webp)
...
Sometimes it was a new project, other times I just scrapped everything I had just built and started over.
...
Turns out that relying purely on excitement to keep you going is not a good strategy.

### Scope Creep

Whenever I started yet another rewrite of Kite, I would have a clear vision for the platform.
Sometimes it was a simple tool for building Discord apps, other times it was a platform for building and hosting WebAssembly apps.
...
I tried to build a platform that would appeal to everyone who wanted to create their own Discord app, from beginners to experts.
...
This helped me narrow down the scope of the project and focus on building features that would be relevant to this audience.
...
I noticed that after the release I was able to focus on the project for longer periods and I'm excited to see where this will lead.
